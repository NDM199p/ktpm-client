...
const BACKEND_URL = 'https://ktpm-server.onrender.com/api/';
...
export class ProductService {
  ...
  getAllCategory(): Observable<ProductCategories[]> {
    return this.http.get<ProductCategories[]>(BACKEND_URL + 'categories');
  }

  getAllFruitAndDrinkCategory(): Observable<ProductCategories[]> {
    return this.http.get<ProductCategories[]>(BACKEND_URL + 'all-categories');
  }

  getFruitCategories(): Observable<ProductCategories[]> {
    return this.http.get<ProductCategories[]>(BACKEND_URL + 'food-categories');
  }
  getDrinkCategories(): Observable<ProductCategories[]> {
    return this.http.get<ProductCategories[]>(BACKEND_URL + 'drink-categories');
  }
  ...
  getOnlyFruits(): Observable<FoodProduct[]> {
    return this.http.get<FoodProduct[]>(BACKEND_URL + 'foods/fruits');
  }
  getOnlyVegetables(): Observable<FoodProduct[]> {
    return this.http.get<FoodProduct[]>(BACKEND_URL + 'foods/vegetables');
  }
  getOnlyMeat(): Observable<FoodProduct[]> {
    return this.http.get<FoodProduct[]>(BACKEND_URL + 'foods/meat-and-poultry');
  }
  getOnlyGrains(): Observable<FoodProduct[]> {
    return this.http.get<FoodProduct[]>(BACKEND_URL + 'foods/grains');
  }
  getOnlyFish(): Observable<FoodProduct[]> {
    return this.http.get<FoodProduct[]>(BACKEND_URL + 'foods/fish-and-seafood');
  }
  ...
  getOnlyDairy(): Observable<FoodProduct[]> {
    return this.http.get<FoodProduct[]>(BACKEND_URL + 'foods/dairy-foods');
  }
  getOnlyAlcoholic(): Observable<FoodProduct[]> {
    return this.http.get<FoodProduct[]>(BACKEND_URL + 'foods/alcoholic-drinks');
  }
  ...
  getOnlyHotDrinks(): Observable<FoodProduct[]> {
    return this.http.get<FoodProduct[]>(BACKEND_URL + 'foods/hot-drinks');
  }
  getOnlyNewProducts(): Observable<FoodProduct[]> {
    return this.http.get<FoodProduct[]>(BACKEND_URL + 'foods/new-products');
  }
  getOnlySaleProducts(): Observable<FoodProduct[]> {
    return this.http.get<FoodProduct[]>(BACKEND_URL + 'foods/sale-products');
  }
